# Publish ColorQuest Kids 2.8.0 Play-readiness release
...
7. Open `https://brecksvillelabs.github.io/colorquest-kids/`. If an older cached copy appears, close the installed app/browser tab and reopen it once so the v2.8.0 offline cache can activate.
8. Confirm the **Android release check** workflow passes on the pull request before merging.
